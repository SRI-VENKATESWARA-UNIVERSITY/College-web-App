import {
  Container, Table, Row, Col, Card, CardText, CardBody,
                  ...
                  <Table bordered responsive>
                    <thead>
                      <tr>
                        ...
                        <th>Details Of Placed Students</th>

                      </tr>
                    </thead>
                    <tbody>
                      {["CHE", "CIV", "EEE", "ECE", "MEC", "CSE"].map((branch) => (
                        <tr key={branch}>
                          <th>{branch}</th>
                          <td>{placementYear[branch][0]}</td>
                          <td>
                            {
                              placementYear[branch][1].startsWith("http") ? (
                                <a href={placementYear[branch][1]} target="_blank" rel="noopener noreferrer">
                                  Click here
                                </a>
                              ) : (
                                placementYear[branch][1]
                              )
                            }
                          </td>
                        </tr>
